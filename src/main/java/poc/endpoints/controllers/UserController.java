...
import poc.endpoints.service.IUserService;

import javax.validation.Valid;

/**
 * Created by shrikanth on 26/7/17.
 */
@Controller
@Api(value = "users", description = "Operations pertaining to user sessions V7 endpoint.")
